...
(function () {
    ...
    */
    LuShu.prototype._setOptions = function (opts) {
        ...
        //记录原始速度
        this._oldSpeed = this._opts.speed;
    }
    ...
    */
    LuShu.prototype.clear = function () {
        this._opts.speed = this._oldSpeed;
        this.stop();
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _addMarker: function (callback) {
            ...
            // +++++++++
            this._polylinePonit.push(new BMap.Point(this._path[0].lng, this._path[0].lat), new BMap.Point(this._path[1].lng, this._path[1].lat));
            var polyline = new BMap.Polyline(this._polylinePonit, {
                strokeColor: this._opts.strokeColor || 'transparent',//	折线颜色
                strokeWeight: this._opts.strokeWeight || 5,//	折线的宽度，以像素为单位
                strokeOpacity: this._opts.strokeOpacity || 1,//	折线的透明度，取值范围0 - 1
                strokeStyle: this._opts.strokeStyle || 'solid',//	折线的样式，solid或dashed
                icons: this._opts.icons || null,//	配置贴合折线的图标
            });
        ...
        _move: function (initPos, targetPos, effect) {
            ...
            me._intervalFlag = setInterval(function () {
                ...
                if (currentCount >= count) {
                    ...
                    // +++++++
                    me._polylinePonit.push(new BMap.Point(pos.lng, pos.lat));
                    me._polyline.setPath(me._polylinePonit);
